-- ============================================================
--  Mehrfachauswahl im Verein-Menü vollständig anzeigen
-- ============================================================
--
-- ------------------------------------------------------------
  ...
  select
    ...
    case
      when f.antworttyp = 'mehrfachauswahl' then (
        ...
        from frage_antwortoptionen o
        where o.frage_id = f.id and o.schluessel = any(a.gegebene_auswahl)
      )
      else case a.gegebene_option
